...
export default function LoginButton({ callbackUrl }: { callbackUrl: string }) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-lg border border-line bg-white px-4 py-3 text-sm font-medium text-gray-800 transition hover:bg-gray-50 disabled:opacity-60"
    >
